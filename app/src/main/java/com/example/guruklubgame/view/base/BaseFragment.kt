...
import com.example.guruklubgame.util.NoConnectivityException
import com.example.guruklubgame.view.ProgressBarListener
import com.example.guruklubgame.view.dialog.NoInternetDialog
...
//        }
    ...
    fun hideKeyboard() {
        ...
        val focusedView = requireActivity().getCurrentFocus()
